%Experiment 2 příklad 1
%Porovnáváme implementace s Rayleighovým a Wilkinsonovým dvojitým shiftem
%Zde je uvedený příklad kdy Wilkinson najde komplexní vlastní čísla i přes
%to, že vlastní čísla jsou reálné
